...
public class Routes implements ApplicationRoutes {
    ...
    public static final String LIST_SQL_QUERY_EXECUTION_API = "/api/sql-query/{sqlQueryId}/execution/{pageNo}/{resultCount}";
    ...
    public void init(Router router) {
        ...
        router.GET().route(LIST_SQL_QUERY_EXECUTION_API).with(SqlQueryApiController.class, "listSqlQueryExecution");
        //Api - End
