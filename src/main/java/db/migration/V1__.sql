...
alter table job_dependent add constraint fk_job_dependent_job_id_fk foreign key (job_id_fk) references job;
alter table job_dependent add constraint fk_job_dependent_dependent_job_id_fk foreign key (dependent_job_id_fk) references job;
alter table job_dependent add constraint uc_job_dependent_job_id_fk_dependent_job_id_fk unique (job_id_fk, dependent_job_id_fk);
