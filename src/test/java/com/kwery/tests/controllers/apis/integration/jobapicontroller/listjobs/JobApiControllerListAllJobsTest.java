...
public class JobApiControllerListAllJobsTest extends AbstractPostLoginApiTest {
    JobModel jobModel;
    ...
    public void test() throws JSONException {
        ...
        assertThat(response, hasJsonPath("$.length()", is(2)));

        for (int i = 0; i < 2; ++i) {
            JobModelHackDto jobModelHackDto = JsonPath.parse(response).read(String.format("$.[%d]", i), JobModelHackDto.class);
