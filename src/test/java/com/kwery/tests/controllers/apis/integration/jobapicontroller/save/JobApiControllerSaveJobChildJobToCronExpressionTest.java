...
public class JobApiControllerSaveJobChildJobToCronExpressionTest extends AbstractPostLoginApiTest {
    @Rule
    ...
    @Before
    public void setUpJobApiControllerSaveJobChildJobToCronExpressionTest() {
